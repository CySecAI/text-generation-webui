...
class ChatCompletionRequestParams(BaseModel):
    ...
    user_name: str | None = Field(default=None, description="Your name (the user). By default, it's \"You\".")
    bot_name: str | None = Field(default=None, description="Overwrites the value set by character field.")
